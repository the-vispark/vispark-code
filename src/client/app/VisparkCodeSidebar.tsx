        ...
        <div className=" pl-3 pr-[7px] h-[64px] max-h-[64px] md:h-[55px] md:max-h-[55px] border-b flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="hidden md:flex group/sidebar-collapse relative items-center justify-center h-7 w-7"
            >
              <BrandMark className="absolute inset-0 h-7 w-7 rounded-xl transition-all duration-200 ease-out opacity-100 scale-100 group-hover/sidebar-collapse:opacity-0 group-hover/sidebar-collapse:scale-0" />
              <PanelLeft className="absolute inset-0 m-auto h-5 w-5 text-slate-500 dark:text-slate-400 transition-all duration-200 ease-out opacity-0 scale-0 group-hover/sidebar-collapse:opacity-100 group-hover/sidebar-collapse:scale-90 hover:opacity-50" />
            </button>
            <BrandMark className="h-7 w-7 rounded-xl md:hidden" />
            <span className="font-logo text-base uppercase tracking-[0.18em] sm:text-[1.05rem] text-slate-600 dark:text-slate-100">{APP_NAME}</span>
          </div>
