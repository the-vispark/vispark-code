...
function BrandLogoIcon({ className }: { className?: string }) {
  return <BrandLogo className={cn("rounded-xl", className)} />
}
            ...
            {!isConnecting ? (
              ...
              <InfoCard>
                <div className="flex items-center justify-around gap-6 py-4 px-2">
                  ...
                  <HowItWorksConnector />
                  <HowItWorksItem icon={BrandLogoIcon} title={`${APP_NAME} UI`} subtitle="Coding Workspace" />
                </div>
              </InfoCard>
              </div>
            ) : null}
            ...
            {projects.length > 0 ? (
              ...
              <InfoCard>
                <p className="text-sm text-muted-foreground">
                  No local projects discovered yet. Open one with Vispark Code, or create a new project here.
                </p>
              </InfoCard>
            )}
            {commandError ? (
