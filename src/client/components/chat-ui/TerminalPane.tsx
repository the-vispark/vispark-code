...
import type { VisparkCodeSocket, SocketStatus } from "../../app/socket"
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden pb-4">
      <div className="flex min-h-0 min-w-0 flex-1 overflow-hidden px-3 py-1">
        <div ref={containerRef} className="vispark-code-terminal min-h-0 min-w-0 flex-1 overflow-hidden w-full" />
      </div>
