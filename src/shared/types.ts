...
export const PROVIDERS: ProviderCatalogEntry[] = [
  {
    ...
    models: [
      { id: "vispark/vision-small", label: "Small", supportsEffort: false },
      { id: "vispark/vision-medium", label: "Medium", supportsEffort: false },
      { id: "vispark/vision-large", label: "Large", supportsEffort: false },
    ],
    efforts: [],
  },
]
